<template>
  <div id="message-send-box-wrapper"
      ...
      <el-dropdown>
        <span class="el-dropdown-link">
          <i class="el-icon-phone-outline"
             v-if="toAccount !== userID"
             title="语音通话"></i>
        </span>
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item id="call_video_yunji"
                            @click.native="trtcCalling('video')">视频通话</el-dropdown-item>
          <el-dropdown-item id="call_audio_yunji"
                            @click.native="trtcCalling('audio')">语音通话</el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
      <!-- <div class="group-live-icon-box"
           v-if="currentConversationType === TIM.TYPES.CONV_GROUP && groupProfile.type !== 'AVChatRoom'"
           title="群直播"
           @click="groupLive">
    ...
    <el-dialog title="发自定义消息"
      ...
      <span slot="footer"
        ...
        <el-button type="primary"
                   @click="sendCustomMessage">确 定</el-button>
      </span>
    </el-dialog>
    <el-dialog title="对IM Web demo的建议和使用感受"
      ...
      <span slot="footer"
        ...
        <el-button type="primary"
                   @click="sendSurvey">确 定</el-button>
      </span>
    </el-dialog>
    <div class="bottom">
    ...
    <div class="calling-member-list"
         v-if="currentConversationType === TIM.TYPES.CONV_GROUP && showCallingMember">
      <calling-member-list @getList="getList"
                           :type="listTpye"></calling-member-list>
      <div class="calling-list-btn">
        <span class="calling-btn"
              @click="cancelCalling">取消</span>
        <span class="calling-btn"
              @click="callingHandler">确定</span>
      </div>
    </div>
  </div>
</template>
